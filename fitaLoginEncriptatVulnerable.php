    ...
    <?php
        ...
        try {
          ...
          if(isset($_POST['username']) && isset($_POST['password'])){
            ...
            $query = $pdo->prepare('SELECT count("nom") as cantidad from users where (nom = "'.$_POST["username"].'" && password = "'.sha1($_POST["password"]).'");');
            $query->execute();
          }   
        ?>

        <form action="fitaLoginEncriptat.php" method="post">
